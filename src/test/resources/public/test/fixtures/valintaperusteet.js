function valintaryhmatFixtures(valintaryhmat) {
  return function () {
    ...
    httpBackend
      .when(
        'GET',
        /.*\/valintaperusteet-service\/resources\/valintaryhma\/.*\/parents/
      )
      .respond(valintaryhmat)
    httpBackend
      .when(
        'PUT',
        /.*\/valintaperusteet-service\/resources\/valintaryhma\/kopioi.*/
      )
      .respond(500, 'Server error')
    httpBackend
      .when(
        'GET',
        /.*\/valintaperusteet-service\/resources\/valintaryhma\/VALINTARYHMA/
      )
      .respond(valintaryhmat[0])
  }
}
function laskentakaavatFixtures(laskentakaavat) {
  return function () {
    var httpBackend = testFrame().httpBackend
    httpBackend
      .when('GET', /.*\/valintaperusteet-service\/resources\/laskentakaava.*/)
      .respond(laskentakaavat)
  }
}
function valintakoeFixtures(valintakoe) {
  return function () {
    var httpBackend = testFrame().httpBackend
    httpBackend
      .when('GET', /.*\/valintaperusteet-service\/resources\/valintakoe\/.*/)
      .respond(valintakoe)
  }
}
    ...
    .respond([
      ...
      },
      {
        ...
        osallistuminenTunniste:
          '42f3fca6-14a0-1a3b-e042-627a30bef63d-OSALLISTUMINEN',
      ...
      },
      {
        ...
        arvot: null,
        osallistuminenTunniste:
          'd3c46564-1700-4c73-eabd-808cf667dad8-OSALLISTUMINEN',
        vaatiiOsallistumisen: true,
        syotettavissaKaikille: false,
      },
      {
        ...
        arvot: null,
        osallistuminenTunniste:
          'efea9350-9bb6-5949-c2aa-b27f1c5784d9-OSALLISTUMINEN',
        vaatiiOsallistumisen: true,
        syotettavissaKaikille: false,
      },
      {

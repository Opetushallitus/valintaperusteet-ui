describe("Valintakokeen muokkaus", function () {
      ...
      lisakysymyksetFixtures([
        {
          ...
          messageText: {
            translations: {
              ...
              en:
                "Which language would you like to use in the entrance examinations?",
            },
          },
          helpText: {
            translations: {},
  ...
  describe("Hakijan valitsema hakukohde", function () {
    it(
      "Vastausvaihtoehtoja ei näy kun lisäkysymyksen tunniste on valitsematta",
      seqDone(
        wait.forAngular,
    ...
    it(
      "Vastausvaihtoehdot tulee näkyviin kun tunniste valitaan",
      seqDone(
        wait.forAngular,
        select(page.kutsunKohde, "HAKIJAN_VALINTA"),

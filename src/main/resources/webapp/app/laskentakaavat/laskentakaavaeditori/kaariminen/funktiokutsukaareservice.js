angular
  ...
  .service("FunktiokutsuKaareService", [
    "_",
    "FunktioService",
    ...
    function (_, FunktioService, FunktiokuvausService) {
      ...
      this.setKaareFunktiokutsuType = function (funktiokutsuNimi) {
        ...
        if (funktiokutsuNimi === "PAINOTETTUKESKIARVO") {
          ...
          api.funktioKaare.argumenttiOptions = api.getJosFunktiokutsuOptions(
            funktiokuvaus
          );
        } else {
          api.funktioKaare.argumenttiOptions = api.getArgumentsNimettyFunktioargumenttiType(
            funktiokuvaus
          );
        }
      };
      ...
      this.getArgumentsNimettyFunktioargumenttiType = function (funktiokuvaus) {
        return _.map(
          _.pluck(funktiokuvaus.funktioargumentit, "nimi"),
          function (nimi, index) {
            return {
              label: nimi,
              index: index,

  ...
  var nameService = new (function () {
    this.nameMappings = {
      ...
      HAEAMMATILLINENYTOARVIOINTIASTEIKKO:
        "Hae ammatillinen yto:n arviointiasteikko",
      ...
      HAEAMMATILLISENTUTKINNONKESKIARVO:
        "Hae ammatillisten tutkinnon tallennettu keskiarvo",
      HAEAMMATILLISENTUTKINNONSUORITUSTAPA:
        "Hae ammatillisen tutkinnon suoritustapa",
      ITEROIAMMATILLISETYTOOSAALUEET:
        "Iteroi ammatillisen tutkinnon YTOn osa-alueet",
      HAEAMMATILLISENYTOOSAALUEENLAAJUUS:
        "Hae ammatillisen tutkinnon YTOn osa-alueen laajuus",
      HAEAMMATILLISENYTOOSAALUEENARVOSANA:
        "Hae ammatillisen tutkinnon YTOn osa-alueen arvosana",
    };

...
angular
  ...
  .factory('FunktioKuvausResource', function ($resource) {
    return $resource(
      window.url('valintaperusteet-service.laskentakaava.funktiokuvaus'),
      {},
      {
  ...
  .factory('KaavaValidointi', function ($resource) {
    return $resource(
      window.url('valintaperusteet-service.laskentakaava.validoi'),
      {},
      {
        post: { method: 'POST' },
      }
  ...
  .factory('KaavaSiirto', function ($resource) {
    return $resource(
      window.url('valintaperusteet-service.laskentakaava.siirra'),
      {},
      { put: { method: 'PUT' } }
    )
  })
  ...
  .factory('Laskentakaava', function ($resource) {
    return $resource(
      plainUrl('valintaperusteet-service.laskentakaava', ':oid'),
      { oid: '@oid' },
      {
  ...
  .factory('HakemusavaimetLomake', function ($resource) {
    return $resource(
      plainUrl('haku-app.lomake.form', ':hakuoid'),
      { hakuoid: '@hakuoid' },
      {

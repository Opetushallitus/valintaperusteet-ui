      ...
      return {
        ...
        link: function ($scope, element, attrs) {
          if (!attrs.ngDisabled) {
            ...
            $log.error(
              "ng-enabled and ng-disabled -directibes shouldn't be user in the same element",
              element
            );
          }
        },
          ...
          if (ngModel != null) {
            ...
            onUpdate = function (e, ui) {
              ...
              ngModel.$modelValue.splice(
                ...
                0,
                ngModel.$modelValue.splice(start, 1)[0]
              );
              return scope.$apply();
            };
            _start = opts.start;
      ...
      return {
        ...
        link: function (scope, elm, attrs, ngModelCtrl) {
          ...
          ngModelCtrl.$parsers.unshift(function (viewValue) {
            if (viewValue) return new Date(viewValue);
            else return "";
          });
        },
      };

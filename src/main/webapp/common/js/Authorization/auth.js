                ...
                MyRolesModel.then(function (model) {
                    if (orgs && orgs.length > 0) {
                        ...
                        orgs.forEach(function (orgOid) {
                            ...
                            orgPromises.push(orgDefer.promise);
                            $http.get(ORGANISAATIO_URL_BASE + "organisaatio/" + orgOid + "/parentoids", { cache: true}).success(function (result) {
                                ...
                                $log('organisaation tietojen haku epäonnistui', error);
                                orgDefer.resolve(); //resolvoidaan deferoitu objekti jokatapauksessa jotta orgPromises-array saadaan resolvoitua
                            });
                        });

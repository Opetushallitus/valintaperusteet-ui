...
angular.module('LaskentakaavaEditor').config(function($routeProvider) {
	...
	when('/valintaryhma/:valintaryhmaOid/laskentakaava', {controller: 'LaskentakaavaListController', templateUrl: TEMPLATE_URL_BASE + 'laskentakaavat/listaus/laskentakaavalista.html', label: 'laskentakaavalista'}).
    ...
    when('/hakukohde/:hakukohdeOid/laskentakaava', {controller: 'HakukohdeLaskentakaavaListController', templateUrl: TEMPLATE_URL_BASE + 'laskentakaavat/listaus/hakukohdelaskentakaavalista.html', label: 'laskentakaavalista'}).

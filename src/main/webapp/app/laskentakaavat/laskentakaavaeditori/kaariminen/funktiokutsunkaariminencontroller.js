angular.module('valintaperusteet')
    ...
    .controller('FunktiokutsunKaariminenController', ['$scope', 'FunktiokutsuKaareService', 'FunktiokuvausService', 'FunktioService', 'FunktioFactory', '$modalInstance', 'funktioasetukset',
        function ($scope, FunktiokutsuKaareService, FunktiokuvausService, FunktioService, FunktioFactory, $modalInstance, funktioasetukset) {

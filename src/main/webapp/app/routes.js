...
app.config(function($routeProvider) {
    ...
    $routeProvider.
        ...
        when('/valintaryhma/:id/userpage', {controller: 'UserPageController', templateUrl:TEMPLATE_URL_BASE + 'User/user.html', label:'user'}).
        ...
        when('/hakukohde/:hakukohdeOid/userpage', {controller: 'UserPageController', templateUrl:TEMPLATE_URL_BASE + 'User/user.html', label:'user'}).
        ...
        when('/valintaryhma/:id/laskentakaavalista', {controller: 'LaskentakaavaListController', templateUrl: TEMPLATE_URL_BASE + 'laskentakaavat/listaus/laskentakaavalista.html', label: 'laskentakaavalista'}).
        when('/valintaryhma/:id/laskentakaavalista/laskentakaava/', {controller: 'LaskentakaavaLomakeController', templateUrl: TEMPLATE_URL_BASE + 'laskentakaavat/laskentakaavaeditori/laskentakaavalomake.html', label: 'laskentakaava'}).
        when('/valintaryhma/:id/laskentakaavalista/laskentakaava/:laskentakaavaOid', {controller: 'LaskentakaavaLomakeController', templateUrl: TEMPLATE_URL_BASE + 'laskentakaavat/laskentakaavaeditori/laskentakaavalomake.html', label: 'laskentakaava'}).
